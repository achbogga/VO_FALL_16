...
-- 1.3. Create regression model (fully connected layers)
local nClasses = 3*3 + 3*1 -- Rotation and Translation
...
classifier:add(nn.MSECriterion()) -- Mean squared error classic regression loss function
